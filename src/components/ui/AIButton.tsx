...
const variants = {
  primary: {
    ...
    color: 'white',
    border: 'none',
    shadow: '0 4px 20px rgba(124,107,255,0.35)',
  ...
  pink: {
    ...
    color: 'white',
    border: 'none',
    shadow: '0 4px 20px rgba(255,107,157,0.35)',
    hoverBg: '#ff85b3',
  },
  cyan: {
    ...
    color: '#080810',
    border: 'none',
    shadow: '0 4px 20px rgba(107,255,204,0.25)',
    hoverBg: '#8affd9',
  },
  amber: {
    ...
    color: '#080810',
    border: 'none',
    shadow: '0 4px 20px rgba(255,184,107,0.25)',
    hoverBg: '#ffc97a',
  },
};
